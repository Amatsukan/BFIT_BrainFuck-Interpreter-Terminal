...
int LoopC = 1; //if 0 = main loop dont works 
int DEBUG = 0; //if 1 = turn on DEBUG mode
int CINPUT = 1; //if 0 = all inputs will be read as [(int) char], otherwise will be read as [char]
int printChar = 1; //if 0 = all inputs will be printed as [(int) char], otherwise will be printed as [char]
int AZERO = 0; //if 1 = After all new command line, the buffer will be erased
